    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Administrator</span>
            </div>

            <form method="post" action="controleAdministrator.php">
                <div class="span4 sidebar">
                    <div class="sidebox" align="center">
                        <input type="text" name="tLogin" id="cLogin" value=""  class="input-block-level" placeholder="Login" required="required" />
                        <input type="password" name="tSenha" id="cSenha" value=""  class="input-block-level" placeholder="Senha" required="required" />
