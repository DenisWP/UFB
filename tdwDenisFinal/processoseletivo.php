...
<div id="divBoxed" class="container">
    ...
    <div class="contentArea">
       ...
       <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Processo Seletivo</span>
            </div>

    <!-- Conexão com o banco de dados para impressão do processo seletivo -->
                
        <h2>Acompanhar Processo Seletivo</h3>
        <h3 style="color:#FF6633;"><?php echo @$_GET['msg'];?></h3>
        <hr>
    
    <!--Start Contact form -->                                                      
    <form name="buscar" method="post" action="" onsubmit="return validation();"> 
        <fieldset>

          <p><h5> Buscas por curso: </h5></p>    
          ...
          <!-- Estou buscando na planilha "cursos" os cursos cadastrados -->       
            ...
            <input type="submit" value="Buscar" name="submit" class="btn btn-info pull-right"/>
                <!-- Aqui faço a comparação, se o curso selecionado no "select" acima
                for igual ao curso escolhido pelo aluno (ambos iguais) ele irá imprimir os candidatos 
                inscritos nele -->
                ...
                $candidatos = "SELECT * FROM candidatos WHERE curso1 = '$curso'";
                $query = $mysqli -> query($candidatos);
                ...
                if($rows > 0){
                    while ($dados = mysqli_fetch_array($query)) {
                        ...
                        echo "<b>Tel. Fixo:</b> " .$dados['telefonefixo']. "<br>";
                        echo "<b>Tel. Celular:</b> " .$dados['telefonecelular']. "<br>";    
                        echo "<b>E-mail:</b> " .$dados['email']. "<br>";
                        echo "<b>Primeira opção:</b> " .$dados['curso1']. "<br>";
                        echo "<b>Segunda opção:</b> " .$dados['curso2']. "<br><br>";
                }

                    }else{
                        echo "<br><br><b>Não há candidatos inscritos para o curso selecionado</b><br>";;
                    }
                ?>
        </fieldset>
    </form>     
