    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="logoutadministrator.php" class="btn btn-info" style="margin:5px 0px 15px;">Sair</a></p></center>
            </div>
           ...
           <div class="row-fluid">
                    ...
                    <div class="span3">                 
                        <div class="box">                       
                            ...
                            <h3 class="title">Cadastrar Curso</h3> <hr/>
                            <p>Realizar cadastro de um novo curso.</p>
                            <p>
                                <a href="cadastrarCurso.php" class="btn btn-info" style="margin:5px 0px 15px;">Cadastrar</a></p>              
                        </div>                      
                    </div> 
                    ...
                    <div class="span3">
                        <div class="box">
                            ...
                            <h3 class="title">Editar Curso</h3> <hr/>
                            <p>Editar um curso cadastrado.</p>
                            <p>
                                <a href="editarCurso.php" class="btn btn-info" style="margin:5px 0px 15px;">Editar</a></p>              
                        </div>
                    </div> 
                    ...
                    <div class="span3">
                       <div class="box">
                            ...
                            <h3 class="title">Excluir Curso</h3> <hr/>
                            <p>Excluir um curso cadastrado.</p>
                             <p>
                                <a href="excluirCurso.php" class="btn btn-info" style="margin:5px 0px 15px;">Excluir</a></p>
                       </div>
                    </div> 
                   ...
                   <div class="span3">
                       <div class="box">
                            ...
                            <h3 class="title">Processo Seletivo</h3> <hr/>
                            <p>Verificar dados do vestibular.</p>
                            <p>
                                <a href="processoseletivo.php" class="btn btn-info" style="margin:5px 0px 15px;">Acompanhar</a></p>
                       </div>
                    </div>
