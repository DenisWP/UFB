    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Engenharia de Controle e Automação</span>
            </div>
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
                    ...
                    <h1><b>Engenharia de Controle e Automação</b></h1>
                    <hr>
                   ...
                   <!-- Aqui irei inserir os dados que serão carregados do banco de dados--> 
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM cursos WHERE codigo = 'ENGCONT'";
