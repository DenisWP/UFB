...
<head>
    ...
    function loginerro(){
        setTimeout("window.location='inscricao.php', 5000");
    }
...
<div id="divBoxed" class="container">
    ...
    <div class="contentArea">
       ...
       <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Acompanhar Processo</span>
            </div>
    ...
    <?php
        ...
        while ($dados = mysqli_fetch_array($query)) {
                ...
                echo "<b>RG:</b> " .$dados['rg']. "<br>";
                echo "<b>Tel. Fixo:</b> " .$dados['telefonefixo']. "<br>";
                echo "<b>Tel. Celular:</b> " .$dados['telefonecelular']. "<br>";    
                echo "<b>E-mail:</b> " .$dados['email']. "<br><br>";
                echo "<b>Primeira opção:</b> " .$dados['curso1']. "<br>";
                echo "<b>Segunda opção:</b> " .$dados['curso2']. "<br><br>";

                echo "<b>Data da Prova:</b> dia 20 de dezembro de 2015 <br>";
                echo "<b>Valor da inscrição:</b> R$: 30,00 <br>";
                echo "<b>Local das provas:</b> UFB - Universidade Federal do Bação <br>";
                echo "<b>Endereço:</b> Rodovia MG 3 - S/N - Bação - Itabirito/MG - Brasil <br><br>";
        }

    ?>
     <a href="inscricao.php" class="btn btn-info" style="margin:5px 0px 15px;">Voltar</a></p>
