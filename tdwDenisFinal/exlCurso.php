...
<div id="divBoxed" class="container">
    ...
    <div class="contentArea">
       ...
       <div class="breadcrumbs">
			...
			<form name="buscar" method="post" action="crtlexlCurso.php" onsubmit="return validation();"> 
			    <fieldset>
 				<?php 
                ...
                $rows = mysqli_num_rows($query);
                    ...
                    if($rows > 0){
                        while ($exibir = mysqli_fetch_array($query)) {
                            ...
                            //Select para o turno dos cursos
                ...
                <input type="submit" value="Excluir" name="submit" class="btn btn-info pull-right"/>
               </fieldset>
            </form>               
